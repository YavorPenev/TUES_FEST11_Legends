        ...
        <div className="p-5 pt-24">
            ...
            <div className="container mx-auto mb-16 flex items-center bg-blue-400 p-5 rounded-lg shadow-lg">
                ...
                <div className="text-left">
                    ...
                    <p className="text-black text-lg">
                        The first highly appreciated developer we must thank for this endeavour is of course Mr. Yavor Penev.
                        ...
                        team's dismay). Mr. Penev's work isn't always
            ...
            <div className="container mx-auto mb-16 flex items-center bg-blue-400 p-5 rounded-lg shadow-lg">
                ...
                <div className="text-left">
                    ...
                    <p className="text-black text-lg">
                    Yet another developer to thank is Mr Kristian Velinov. As the main React developer, it comes to
                        ...
                        best to work with and keep unchanged throughout the entirety of the project.  These hardships have also almost caused a
            ...
            <div className="container mx-auto mb-16 flex items-center bg-blue-400 p-5 rounded-lg shadow-lg">
                ...
                <div className="text-left">
                    ...
                    <p className="text-black text-lg">
                    The third member of the team is Mr. Kristiyan Mihailov. As yet another key developer, he is
                        ...
                        users personalized and customizable options to choose from. 
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto mb-16 flex items-center bg-blue-400 p-5 rounded-lg shadow-lg">
                ...
                <div className="text-left">
                    ...
                    <p className="text-black text-lg">
                    As the fourth member of the team Mr. bobi77 'Stoynev' is yet another vital cog in the machine that is
                        ...
                        Basheva, which is an achievement in itself. 
                    </p>
                </div>
            </div>
            ...
            <div className="container mx-auto flex items-center bg-blue-400 p-5 rounded-lg shadow-lg">
                ...
                <div className="text-left">
                    ...
                    <p className="text-black text-lg">
                    Last but not least comes our equally cherished developer Mr Dein. He is the one responsible for this
                        ...
                        experience in it too. Autographs from 24:10 to 24:15, PMT, Timor Leste.
                    </p>
                </div>
            </div>
        </div>
