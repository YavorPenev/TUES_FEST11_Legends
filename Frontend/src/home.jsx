    ...
    element={
     <div className="pt-20">
        ...
        <div className="flex justify-center items-center pb-5 pt-5 w-full flex-col bg-gradient-to-b from-blue-100 to-gray-400 border-b-8 border-blue-900">
          ...
          <Link
            to="/faq"
            className="absolute top-[39%] right-4 bg-blue-900 pt-2 pb-2 pr-5 pl-5 rounded-2xl text-2xl font-extrabold text-blue-100 hover:scale-110 transition-transform duration-200"
          >
            ?
          </Link>
