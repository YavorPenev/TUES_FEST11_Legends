  ...
  return (
    <>
        ...
        <div className="mt-26 h-110 mb-40">
          ...
          <div className='flex justify-evenly flex-col absolute left-[15%] w-[30%] mr-[10%] h-96 justify-items-center items-center bg-blue-800 rounded-3xl mt-10'>
          ...
          <div className='pb-10 pt-10 flex justify-evenly flex-col absolute right-[15%] w-[30%] ml-[10%] h-96 justify-items-center items-center bg-blue-800 rounded-3xl mt-10 '>
